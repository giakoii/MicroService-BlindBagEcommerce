...
namespace AccessoryService.Utils;
...
public class LoggingUtil
{
    ...
    {
        var folderPath = Path.GetFileName(Path.GetDirectoryName(System.AppDomain.CurrentDomain.BaseDirectory));
    ...
    {
        var message = JsonSerializer.Serialize(response, jsonSerializerOptions);
        var maxLength = 5000;
